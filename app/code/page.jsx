      ...
      <div className="min-h-screen bg-[#0B0C14] text-white flex flex-col">
        ...
        <div className="border-b border-[#1A1B25] p-6">
          <div className="max-w-4xl mx-auto">
            ...
            <pre className="whitespace-pre-wrap text-gray-300 font-normal">{currentProblem.description}</pre>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto flex gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 flex space-x-4">
                <Button className="flex-1 bg-purple-600 hover:bg-purple-700" onClick={handleSubmit} disabled={loading}>
                  {loading ? (
            ...
            {/* Right side: Feedback */}
            {feedback && (
              <div className="w-1/3 bg-[#1A1B25] rounded-xl p-4 h-fit">
